...
plt.xlabel("Distribution of factorized Type")
...
plt.xlabel("Distribution of Released Year")
...
plt.xlabel("Distribution of factorized Genres")
...
plt.xlabel("Distribution of factorized Production Countries")
...
plt.xlabel("Distribution of imdb score")
