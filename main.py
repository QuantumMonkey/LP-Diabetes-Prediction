...
def data_info(dataset):  # Display stats and null values
    """
    :param dataset: object type data
    :use Prints statistical information about the specified dataset
    :return: Nothing
    """
    print("Top 5 rows:\n", dataset.head(), '\n')  # Display top 5 rows
...
def data_clean(dataset):  # Drop null values
    """
        :param dataset: object type data
        :use Removes records with null values from essential columns of the specified dataset
